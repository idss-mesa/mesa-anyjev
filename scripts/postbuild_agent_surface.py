#!/usr/bin/env python3
"""Post-build step: make the rendered mesa-anyjev site consumable by AI agents.
...
1. Mirrors every source Markdown file — OKF v0.2 frontmatter intact — into
   ...
   `index.md` (e.g. https://idss-mesa.github.io/mesa-anyjev/getting-started/api-token/index.md).
...
def main():
    ...
    (site / "robots.txt").write_text(
        f"# mesa-anyjev documentation — {base}\n"
        ...
        "#   For NEON data itself, connect to the mesa-anyjev server (stdio or\n"
